...
from cal_kd_rsi_2 import calculate_KD__RSI#coding=utf-8
...
def monthly_report(year, month):
    ...
    month_price_df=DataFrame(month_price_ts,columns=['month_revenue'])
    print month_price_df
    file_name6 = 'D:\Python27\Taiwan_stock_data_daily\KD__RSI\month_price_%s.csv' % '103_01'
    month_price_df.to_csv(file_name6)


print monthly_report(103, 1)
